...
pdf(file='manuscript/Figs/error_rate_line_v5.pdf', width=1.75, height=1.5)

par(mar=c(0.5,2,0.1,0.1), oma=c(1,0,0,0), cex.axis=0.7, pty='s')

plot(0, 0, type='n', xlim=c(-3.3, -0.7), ylim=c(-3.7, -0.7),
     xlab=NA, ylab=NA, xaxt='n', yaxt='n')

# grid()
abline(v=log10(fdr_levels), col = "grey70", lty = "dotted", lwd=1)
abline(h=c(log10(0.0003), log10(fdr_levels)), col = "grey70", lty = "dotted", lwd=1)
...
axis(2, at=c(log10(0.0003), log10(fdr_levels)), labels=c(NA, '0.1%', NA, '1%', NA, '10%'),
