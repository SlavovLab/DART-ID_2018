...
ev.f <- ev %>%
  ...
  dplyr::select(c('Modified sequence', 'Sequence', 'Leading razor protein', 'Raw file', 
...
pdf(file='manuscript/Figs/inference_fdr_increase.pdf', width=7, height=2.5)

par(mar=c(2.2,7,1.75,7),
    #pty='s', 
    las=1,
    cex.axis=0.85, cex.lab=1, cex.main=1)

plot(0, 0, type='n',
     xlim=c(-3.1, -0.5), ylim=c(-15, 180),
